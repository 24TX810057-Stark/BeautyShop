				...
				<div class="container">
					<div class="promo-bar__content">
						<span class="promo-item"><i class="bi bi-gift"></i> FREESHIP
							...
							Giảm 20% cho thành viên mới</span> <span class="promo-item"><i class="bi bi-star"></i> Tích
							điểm đổi quà hấp dẫn</span> <span class="promo-item"><i class="bi bi-shield-check"></i> Cam
							kết
							100% chính hãng</span>
					</div>
				</div>
						...
						<div class="category-sidebar">
							...
							<ul class="category-sidebar__list">
								<c:forEach var="cat" items="${categories}">
									<c:if test="${cat.id != 6}">
										<li><a href="${pageContext.request.contextPath}/product?cid=${cat.id}">
						...
						<div class="hero-banner">
							<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
								...
								<c:choose>
										...
										<div class="carousel-indicators">
											<c:forEach var="banner" items="${banners}" varStatus="status">
												<button type="button" data-bs-target="#heroCarousel"
													data-bs-slide-to="${status.index}" ${status.first
														...
														<c:when test="${not empty banner.link}">
															<a href="${banner.link}">
																<img src="${pageContext.request.contextPath}/uploads/${banner.image}"
																	class="d-block w-100 hero-banner__img"
																	alt="${banner.title}">
															</a>
														</c:when>
														<c:otherwise>
									...
									<c:otherwise>
										<!-- Fallback: hiển thị banner mặc định nếu chưa có trong DB -->
										<div class="carousel-indicators">
				...
				<div class="category-icons">
					<div class="row justify-content-center">
						<div class="col-6 col-md-4 col-lg-2 mb-4">
							<a href="${pageContext.request.contextPath}/product?type=best-seller"
								class="category-icon-card best-seller-card">
								<div class="category-icon-card__image">
									<img src="${pageContext.request.contextPath}/assets/images/best-seller.png"
										alt="Best Seller">
								</div>
