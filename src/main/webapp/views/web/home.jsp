	...
	<%@ taglib prefix="c" uri="jakarta.tags.core" %>
		<%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
			...
			<div class="promo-bar">
				<div class="container">
					<div class="promo-bar__content">
						<span class="promo-item"><i class="bi bi-gift"></i> FREESHIP đơn từ 300K</span>
						<span class="promo-item"><i class="bi bi-percent"></i> Giảm 20% cho thành viên mới</span>
						<span class="promo-item"><i class="bi bi-star"></i> Tích điểm đổi quà hấp dẫn</span>
						<span class="promo-item"><i class="bi bi-shield-check"></i> Cam kết 100% chính hãng</span>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="category-sidebar">
							...
							<ul class="category-sidebar__list">
								<li><a href="#"><i class="bi bi-chevron-right"></i> Chăm sóc da mặt</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Trang điểm</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Chăm sóc cơ thể</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Chăm sóc tóc</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Nước hoa</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Phụ kiện làm đẹp</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Dược mỹ phẩm</a></li>
								<li><a href="#"><i class="bi bi-chevron-right"></i> Best Seller</a></li>
							</ul>
						</div>
					</div>
									...
									<div class="carousel-item active">
										<div class="hero-banner__slide hero-banner__slide--1">
											<div class="hero-banner__content">
												...
												<p class="hero-banner__desc">Giảm đến 50% tất cả sản phẩm chăm sóc da
												</p>
				...
				<div class="category-icons">
					<div class="row justify-content-center">
						<div class="col-6 col-md-4 col-lg-2 mb-4">
							<a href="#" class="category-icon-card">
								<div class="category-icon-card__image">
									<i class="bi bi-droplet" style="font-size: 40px; color: var(--primary);"></i>
								</div>
						...
						<div class="col-6 col-md-4 col-lg-2 mb-4">
							<a href="#" class="category-icon-card">
								<div class="category-icon-card__image">
									<i class="bi bi-brush" style="font-size: 40px; color: var(--primary);"></i>
								</div>
						...
						<div class="col-6 col-md-4 col-lg-2 mb-4">
							<a href="#" class="category-icon-card">
								<div class="category-icon-card__image">
									<i class="bi bi-flower1" style="font-size: 40px; color: var(--primary);"></i>
								</div>
						...
						<div class="col-6 col-md-4 col-lg-2 mb-4">
							<a href="#" class="category-icon-card">
								<div class="category-icon-card__image">
									<i class="bi bi-scissors" style="font-size: 40px; color: var(--primary);"></i>
								</div>
						...
						<div class="col-6 col-md-4 col-lg-2 mb-4">
							<a href="#" class="category-icon-card">
								<div class="category-icon-card__image">
									<i class="bi bi-heart-pulse" style="font-size: 40px; color: var(--primary);"></i>
								</div>
			...
			<section class="section-padding section-soft-bg">
				<div class="block-header">
					<div class="block-header__left">
						<h3 class="block-header__title"><i class="bi bi-lightning-charge-fill"></i> Flash Sale</h3>
				...
				<div class="row">
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card">
							...
							<div class="product-card__brand">Laneige</div>
							<h4 class="product-card__name">Mặt nạ ngủ Water Sleeping Mask</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">450,000đ</span>
								<span class="product-card__price-old">600,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card">
							...
							<div class="product-card__brand">The Face Shop</div>
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card">
							<div class="product-card__thumb">
								<span class="product-card__badge">-35%</span>
								<div class="product-card__placeholder">
									<i class="bi bi-image"></i>
								</div>
							</div>
							<div class="product-card__brand">Maybelline</div>
							<h4 class="product-card__name">Son môi SuperStay Matte Ink</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">175,000đ</span>
								<span class="product-card__price-old">269,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card">
							<div class="product-card__thumb">
								<span class="product-card__badge">-40%</span>
								<div class="product-card__placeholder">
									<i class="bi bi-image"></i>
								</div>
							</div>
							<div class="product-card__brand">COSRX</div>
							<h4 class="product-card__name">Toner AHA/BHA Clarifying</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">220,000đ</span>
								<span class="product-card__price-old">369,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
			...
			<section class="section-padding">
				<div class="block-header">
					<div class="block-header__left">
						<h3 class="block-header__title"><i class="bi bi-fire"></i> Sản Phẩm Nổi Bật</h3>
				...
				<div class="row">
					...
					<div class="col-6 col-md-4 col-lg-2-4 mb-4">
						<div class="product-card">
							...
							<h4 class="product-card__name">Son Black Rouge Air Fit Velvet</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">189,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
					...
					<div class="col-6 col-md-4 col-lg-2-4 mb-4">
						<div class="product-card">
							...
							<div class="product-card__price">
								...
								<span class="product-card__price-old">375,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
					...
					<div class="col-6 col-md-4 col-lg-2-4 mb-4">
						<div class="product-card">
							...
							<div class="product-card__price">
								<span class="product-card__price-current">420,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
					...
					<div class="col-6 col-md-4 col-lg-2-4 mb-4">
						<div class="product-card">
							...
							<h4 class="product-card__name">Dầu gội Tsubaki Premium Repair</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">265,000đ</span>
								<span class="product-card__price-old">295,000đ</span>
							</div>
							<div class="product-card__meta">
								<div class="product-card__rating">
									<i class="bi bi-star-fill"></i>
			...
			<section class="section-padding section-soft-bg">
				<div class="block-header">
					<div class="block-header__left">
						<h3 class="block-header__title"><i class="bi bi-box-seam"></i> Sản Phẩm Mới</h3>
				...
				<div class="row">
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card product-card--new">
							...
							<h4 class="product-card__name">Serum Vitamin C Melano CC Rohto</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">285,000đ</span>
							</div>
							<div class="product-card__buy">
								<a href="#" class="btn-buy">Xem chi tiết</a>
							</div>
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card product-card--new">
							...
							<h4 class="product-card__name">Kem dưỡng ẩm Dear Klairs Rich Moist</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">450,000đ</span>
							</div>
							<div class="product-card__buy">
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card product-card--new">
							...
							<h4 class="product-card__name">Phấn highlight Becca Shimmering</h4>
							<div class="product-card__price">
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card product-card--new">
							...
							<h4 class="product-card__name">Mascara Maybelline Sky High</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">225,000đ</span>
							</div>
							<div class="product-card__buy">
								<a href="#" class="btn-buy">Xem chi tiết</a>
							</div>
					...
					<div class="col-6 col-md-4 col-lg">
						<div class="product-card product-card--new">
							...
							<h4 class="product-card__name">Nước hoa Chanel Coco Mademoiselle</h4>
							<div class="product-card__price">
								<span class="product-card__price-current">2,850,000đ</span>
							</div>
							<div class="product-card__buy">
								<a href="#" class="btn-buy">Xem chi tiết</a>
							</div>
